Pod::Spec.new do |spec|
  spec.name         = 'ScanflowDocumentCapture'
  spec.version      = '2.0.3'
...
Scanflow is an AI scanner promises technological solutions to any enterprise that transform any smart device camera into an intelligent data capture device for seamless scanning and workflow automation. '
  ...
  spec.source       = {:http => 'https://console.scanflow.ai/sdk/downloads/ScanflowDocumentCapture.framework.zip'}
  spec.vendored_frameworks = 'ScanflowDocumentCapture.framework'
